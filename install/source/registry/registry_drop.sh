...
# ---------------------------------------------------------------
# Run scripts for dropping HiTViSc registry database
# ---------------------------------------------------------------
...
# Drop database, user and owner role
echo "------------------------------------------------------------------------------------------------"
echo "--- Drop database, user and owner role"
echo "------------------------------------------------------------------------------------------------"
psql --dbname=postgres -f ./scripts/00_database/drop_db.sql
