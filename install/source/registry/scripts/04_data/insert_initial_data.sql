...
INSERT INTO registry.user(id, create_time, login, email, password_hash, name, description, state, boinc_user_id, boinc_authenticator, boinc_password, project_prefs) VALUES(NEXTVAL('registry.seq_user_id'), CURRENT_TIMESTAMP, 'adm.hitvisc@yandex.ru', 'adm.hitvisc@yandex.ru', MD5('password'), 'Administrator', 'Administrator of HiTViSc system', 'U', 1, '589f3b592c15558d947a2b902c3b640e', 'regnode', LOAD_FILE('/var/lib/mysql-files/hitvisc_project_prefs.xml'));
--------------------------------------------------------------------------------
