...
# Usage: 
USAGE_TEMPLATE="hitvisc_add_target.sh TMPDIR FRONT_ENTITY_ID NAME DESCRIPTION AUTHORS SOURCE USAGE_TYPE FILE_LOADED FILENAME ORIGINAL_FILENAME EXTENSION PDB_ID REFLIG_EXTRACT REFLIG_EXIST REFLIG_FILENAME REFLIG_ORIGINAL_FILENAME REFLIG_EXTENSION"
