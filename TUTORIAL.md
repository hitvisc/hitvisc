...
# Убедиться, что находимся в рабочей директории: например, /home/user/work
cd hitvisc/install
ansible-playbook hitvisc-install.yml && ansible-playbook postgresql-install.yml && ansible-playbook hitvisc-main-install.yml && ansible-playbook boinc-install.yml && ansible-playbook hitvisc-boinc-install.yml && ansible-playbook registry-install.yml && ansible-playbook third-party-install.yml && ansible-playbook frontend-install.yml
```
